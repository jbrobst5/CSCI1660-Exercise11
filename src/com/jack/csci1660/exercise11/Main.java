package com.jack.csci1660.exercise11;

/*
Modify the WeatherStation example from the lecture notes to include a PressureSensor class that implements
WeatherDataSource and reports atmospheric pressure data; it should behave similar to TemperatureSensor and HumiditySensor.
Update Main.main() to register the WeatherStation instance as a listener for an instance of PressureSensor and
demonstrate an update of pressure data from the instance.
 */
...
class PressureSensor implements WeatherDataSource {
    ...
    private double currentPressure; // inches of mercury
    private List<WeatherDataListener> listeners = new ArrayList<>();
    ...
    private void updatePressure() {
        // Record lowest: 25.9, Record highest: 32.01
        currentPressure = 26.0 + (new Random().nextDouble() * 6.0);
    }
